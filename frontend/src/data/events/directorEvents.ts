...
export const directorEvents: DecisionEvent[] = [
...

  {
    ...
    options: [
      ...
      {
        id: 'dir_001_opt_d',
        text: '🔧 精益资源统筹（需工作能力≥55）',
        feedback: '你凭借卓越的多项目管理能力，实施了精益资源统筹。通过动态调配和资源共享，所有项目都获得了最优资源分配，创造了管理奇迹！',
        requiredAbility: { workAbility: 55 },
        hidden: true,
        effects: {
          health: -2,
          reputation: 9,
...

  {
    ...
    options: [
      ...
      },
      {
        id: 'dir_002_opt_d',
        text: '🎲 豪赌战略机遇（需幸运≥55）',
        feedback: '你敏锐地察觉到这是千载难逢的战略机遇，力排众议全力推动！项目大获成功，为公司带来了巨额利润，你的战略眼光无人质疑！',
        requiredAbility: { luck: 55 },
        riskFactor: 0.3,
        hidden: true,
        failureFeedback: '很不幸，你的战略判断失误了！项目投入巨大但市场反应冷淡，公司损失惨重，你的战略眼光受到严重质疑。',
        effects: {
          health: -3,
          reputation: 12,
          cash: 20000,
...

  {
    ...
    options: [
      ...
      {
        id: 'dir_003_opt_d',
        text: '🔧 创新市场开拓（需工作能力≥55）',
        feedback: '你凭借丰富的市场经验，制定了创新的市场开拓策略。通过差异化定位和精准营销，公司在竞争中脱颖而出，快速占领新市场！',
        requiredAbility: { workAbility: 55 },
        hidden: true,
        effects: {
          health: -3,
