...
| 项目总监 | 🎯 | 1,200万 | 22 | 90 | 5个优质项目 | 18万 - 28万 |
...
**关系要求表**（v1.4 更新，6级职级系统）:

| 职级晋升 | 核心关系要求 | 要求类型 | 说明 |
|---------|-------------|---------|------|
| 实习生 → 工程师 | 甲方≥50 **或** 劳务队≥50 | any（任一） | 实习生只能维护甲方和劳务队 |
| 工程师 → 高级工程师 | 监理≥60、设计院≥60 | all（全部） | 工程师一次性解锁监理和设计院 |
| 高级工程师 → 项目经理 | 甲方≥70、劳务队≥65 | all（全部） | 高工需要协调甲方和劳务 |
| 项目经理 → 项目总监 | 所有关系≥70 | all（全部） | 总监级需要全方位资源 |
| 项目总监 → 合伙人 | 所有关系≥80 | all（全部） | 合伙人需要更高的关系要求 |
